...
export type OeeSection = 'master' | 'input' | 'view' | 'users'
...
const SECTION_REQUIRED: Record<OeeSection, string> = {
  master: 'Administrator or Plant Manager',
  input:  'Administrator, Plant Manager, or Operator',
  view:   'all roles',
  users:  'Administrator',
}
      ...
      <div className="flex flex-col items-center justify-center h-[60vh] gap-4 text-center px-4">
        ...
        <div className="space-y-1">
          ...
          <p className="text-sm text-muted-foreground max-w-sm">
            <span className="font-medium text-slate-700">{SECTION_LABELS[section]}</span> is
            restricted to <span className="font-medium text-slate-700">{SECTION_REQUIRED[section]}</span>.
          </p>

...
import { availabilityData, AvailabilityRow } from "@/types/availability-types"
...
export default function AvailabilityRatePage() {
  ...
  async function exportExcel(){
    ...
    saveAs(blob,"availability-rate.xlsx")
...
<OeeGuard section="view">
      ...
      {/* TABLE (optional reusable component) */}

...
import {
  ...
  GripVertical, Star, Package, Info,
} from 'lucide-react'
                      ...
                      <span className="flex items-center gap-1.5">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent side="top" className="max-w-[260px] text-xs">
                            Definisi akan ditampilkan sebagai keterangan tooltip saat hover di form Input Output.
                          </TooltipContent>
                        </Tooltip>
                      </span>
                    </TableHead>
                          ...
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <span className="flex items-center gap-1.5 cursor-default">
                                ...
                                <span className="truncate max-w-[160px]">{row.remarks}</span>
                              </span>
                            </TooltipTrigger>
                            <TooltipContent side="left" className="max-w-[280px] text-xs leading-relaxed">
                              <p className="font-semibold text-violet-300 mb-1">{row.name}</p>
                              {row.remarks}
                            </TooltipContent>
                          </Tooltip>
                        ) : (
                          <span className="text-muted-foreground/50 text-xs italic">Belum ada definisi</span>
                        )}
                      </TableCell>
                      <TableCell className="text-center">
                ...
                <Label className="flex items-center gap-1.5">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent side="right" className="max-w-[240px] text-xs">
                      Definisi ini akan muncul sebagai tooltip saat pengguna hover di atas nama kategori pada form Input Output.
                    </TooltipContent>
                  </Tooltip>
                </Label>
                <Textarea
                  placeholder="Contoh: Produk jadi yang sudah melewati proses QC dan siap kirim..."
                  rows={3}
                  value={form.remarks}
                  onChange={e => setField('remarks', e.target.value)}
                />
                <p className="text-xs text-muted-foreground">Isi definisi agar pengguna memahami kategori ini saat input data produksi.</p>
              </div>
            </div>
            {formError && (
